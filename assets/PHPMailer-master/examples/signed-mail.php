...
$mail->setFrom('smpks17@gmail.com', 'First Last');
//Set an alternative reply-to address
$mail->addReplyTo('smpks17@gmail.com', 'First Last');
//Set who the message is to be sent to
$mail->addAddress('lorik.kra@msn.com', 'John Doe');
...
$mail->sign(
    '../../cert.crt', //The location of your certificate file
    '/path/to/cert.key', //The location of your private key file
    'smponlone', //The password you protected your private key with (not the Import Password! may be empty but parameter must not be omitted!)
