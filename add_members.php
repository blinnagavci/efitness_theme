                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" class="form-horizontal form-groups-bordered">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="member_firstname" class="form-control" id="member_firstname" placeholder="">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="member_surname" class="form-control" id="member_surname" placeholder="">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <select name="member_gender" class="form-control" id="gender_select">
								...
								<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="member_city" class="form-control" id="member_city" placeholder="">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="member_telephone" class="form-control" id="member_telephone" placeholder="">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="member_alternative" class="form-control" id="member_alternative" placeholder="">
                                        </div>
                                    </div>
							...
							<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="membership_amount" class="form-control" id="membership_amount" placeholder="">
                                        </div>
                                    </div>
